...
class ExpenseAnalysisScreen extends StatefulWidget {
  ...
  @override
  State<ExpenseAnalysisScreen> createState() =>
      _ExpenseAnalysisScreenState();
}

class _ExpenseAnalysisScreenState
    extends State<ExpenseAnalysisScreen> {
  int _selectedTab = 1;
  ...
  Color get bgColor =>
      isDark ? const Color(0xFF0F172A) : AppTheme.surface;
  ...
  Widget build(BuildContext context) {
    ...
    final chartData = _selectedTab == 2
        ? _localMonthlyData
        : _localDailyData;
