...
class _ExpenseAnalysisScreenState extends State<ExpenseAnalysisScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final chartData = isMonth ? report.dailyExpense : report.monthlyExpense;
    final totalAmount = isMonth ? report.totalExpense : chartData.fold<double>(0, (s, e) => s + (e['total'] as num).toDouble());
                    ...
                    children: [
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text('BIỂU ĐỒ CHI TIÊU', style: Theme.of(context).textTheme.labelSmall?.copyWith(letterSpacing: 1.2)),
